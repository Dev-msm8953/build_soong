...
var (
	...
	ClangDefaultVersion      = "clang-neutron"
	ClangDefaultShortVersion = "18.0.0"
...
func init() {
	...
	pctx.SourcePathVariable("RSClangVersion", "clang-neutron")
	pctx.SourcePathVariable("RSReleaseVersion", "18.0.0")
